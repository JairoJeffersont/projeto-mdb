                ...
                <div class="card bg-transparent border-0" style="min-width: 300px; max-width: 400px; width: 100%;">
                    <div class="card-body">
                        ...
                        <form method="post" enctype="application/x-www-form-urlencoded" class="mb-3">
                            <div class="mb-2">
                                <input type="email" class="form-control rounded-pill fs-6" id="email" name="email" placeholder="Email" value="jairojeffersont@gmail.com" required>
                            </div>
                            <div class="mb-3">
                                <input type="password" class="form-control rounded-pill fs-6" id="password" name="password" placeholder="Senha" value="intell01" required>
                            </div>
                            <div class="d-grid">
